...
crt:
	...
	-nodes -keyout srcs/requirements/nginx/certs/server.key -out srcs/requirements/nginx/certs/server.crt \
	-subj "/CN=bakgun.42.fr"
fclean:
	...
	rm -rf srcs/requirements/nginx/certs/server.key srcs/requirements/nginx/certs/server.crt
